...
class AddContent extends Component {
  ...
  handleFormSubmit = async (e) => {
    ...
    const { userDetailsId } = JSON.parse(localStorage.getItem('userDetails'));
    ...
    this.props.addContent(content, this.props);
...
export default connect(mapStateToProps, { addContent })(AddContent);
